...
|---|---|---|---|---|---|---|---|
| random-baseline | 500 | 0.0720 | 0.0350 | 0.0000 | 0.0000 | 0.2900 | 0.2102 |
...
| 模型 | 易 | 中 | 难 |
|---|---|---|---|
| random-baseline | 0.2001 | 0.0454 | 0.0137 |
...
| random-baseline | T3 幻觉识别 | 0.6970 | 0.1765 | 0.0000 |
